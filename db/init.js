...
const dbPath = path.join(__dirname, '..', 'gastrofy.db');
...
if (tables.length > 0) {
    ...
    console.log('   Wenn du neu initialisieren möchtest, lösche gastrofy.db zuerst.');
    process.exit(0);
}
...
console.log(`   Admin:  admin@gastrofy.app / admin123`);
